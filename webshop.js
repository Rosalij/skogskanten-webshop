...
//if the webpage has the name webshop, load products
if (window.location.href == "https://skogskanten.netlify.app/webshop") {
    ...
    //function for showing products in webshop page, using JSON
    function showProducts(products) {
        ...
        products.forEach((product) => {
            ...
            productEl.innerHTML = `<a href = "${product.id}" 
<picture> 
<source srcset="${product.smallimages.webp}" type="image/webp" </source>
<img src="${product.smallimages.jpeg}" alt="${product.name}" width="360" height="360"></img>
</picture><div>
<h3>${product.name}</h3><a/>
<p>${product.price} SEK</p></div>`;
...
* 
* Ändringar gjorda: översatt svenska meningar till engelska
*
*/
...
function addToBasket(el, id, name, cost, image, notify = false) {
    ...
    if (notify == true) {
        ...
        if (document.getElementById("notify")) {
            let notifyText = "<p>Item <b>" + name + "</b> added</p>";
    ...
    if (document.getElementById("basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            for (let i = 0; i < basketItems.length; i++) {
                ...
                let newItemCountText = document.createTextNode(basketItems[i].nums + ", ");
            ...
            // Tomt i listan
            basket.innerHTML = "<li>No items selected</li>";
...
function showSmallBasket() {
    if (document.getElementById("small-basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            smallBasketEl.innerHTML = numOfItems + " items, " + sum + ":-";
...
function showCheckout() {
    if (document.getElementById("checkout")) {
        ...
        if (basketItems.length > 0) {
            ...
            // Lägg till summan sist
            checkoutEl.innerHTML += "<tr>" +
                "<td colspan='5' class='checkout-sum'>Price: " + sum + ":-</td>";

        } else {
            // Tomt i listan
            checkoutEl.innerHTML = "<tr><td colspan='5'>Your shopping bag is empty</td></tr>"
                ;
...
function checkoutBasket() {
    ...
    if (basketItems != null) {
        ...
        if (itemCount == 1) {
            alert("Thank you for your order! One item - total price: " + totalSum + ":-");
        } else {
            alert("Thank you for your order! " + itemCount + " items - total price " + totalSum + ":-");
        }
        ...
        alert("You have no items in your shopping bag!");
    }
}
